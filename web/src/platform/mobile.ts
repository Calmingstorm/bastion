...
const mobileStorage: PlatformStorage = {
...
export async function initMobilePlatform(): Promise<Platform> {
  await initStore();
  ...
  return {
    ...
    getOrigin: () => {
      return mobileStorage.getItem('serverUrl') || 'https://bastions.org';
    },
    ...
    setTitle: () => {
      // No-op on mobile — Android manages the app title
    },
